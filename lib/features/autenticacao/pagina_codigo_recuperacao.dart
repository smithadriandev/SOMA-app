...
class PaginaCodigoRecuperacao extends StatefulWidget {
  const PaginaCodigoRecuperacao({super.key});

  @override
  State<PaginaCodigoRecuperacao> createState() => _PaginaCodigoRecuperacaoState();
}

class _PaginaCodigoRecuperacaoState extends State<PaginaCodigoRecuperacao> {
