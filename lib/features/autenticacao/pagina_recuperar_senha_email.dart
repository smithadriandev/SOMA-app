...
class PaginaRecuperarSenhaEmail extends StatefulWidget {
  const PaginaRecuperarSenhaEmail({super.key});

  @override
  State<PaginaRecuperarSenhaEmail> createState() =>
      _PaginaRecuperarSenhaEmailState();
}

class _PaginaRecuperarSenhaEmailState extends State<PaginaRecuperarSenhaEmail> {
